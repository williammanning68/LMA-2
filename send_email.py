...
def _build_detection_row(kw, hoa, lc, tot):
    ...
    return (
        "<tr>"
        "<td width=\"28%\" style='border-top:none;border-left:solid #D8DCE0 1px;border-bottom:solid #ECF0F1 1px;border-right:none;padding:1px 1px;'>"
        ...
        "<td width=\"28%\" style='border-bottom:solid #ECF0F1 1px;padding:8px 1px;'>"
        ...
        "<td width=\"28%\" style='border-bottom:solid #ECF0F1 1px;padding:1px 1px;'>"
        ...
        "<td width=\"15%\" style='border-bottom:solid #ECF0F1 1px;border-right:solid #D8DCE0 1px;padding:1px 1px;'>"
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;border:1px solid #D8DCE0;">
  <tr>
    <td valign="top" style="background:#ECF0F1;border-bottom:1px solid #D8DCE0;padding:6px 10px;font-size:0;line-height:0;mso-line-height-rule:exactly;vertical-align:top;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
        <tr>
          <td width="36" align="center" valign="top" style="background:#4A5A6A;border:0;height:1px;vertical-align:top;">
            <div style="font:bold 10pt 'Segoe UI',sans-serif;color:#FFFFFF;line-height:1px;mso-line-height-rule:exactly;display:block;">{idx}</div>
          </td>
          <td width="10" style="font-size:0;line-height:0;vertical-align:top;">&nbsp;</td>
          <td valign="top" style="vertical-align:top;">
            <div style="font:bold 10pt 'Segoe UI',sans-serif;color:#24313F;text-transform:uppercase;line-height:1px;mso-line-height-rule:exactly;display:block;">{_esc(speaker) or 'UNKNOWN'}</div>
          </td>
          <td align="right" valign="top" style="vertical-align:top;">
            <div style="font:10pt 'Segoe UI',sans-serif;color:#6A7682;line-height:1px;mso-line-height-rule:exactly;display:block;">{line_txt}</div>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td valign="top" style="padding:1px 1px;vertical-align:top;">
      <div style="font:10pt 'Segoe UI',sans-serif;color:#1F2A36;line-height:1px;mso-line-height-rule:exactly;display:block;">{excerpt_html}</div>
    </td>
  </tr>
</table>
""")
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse;">
  <tr>
    <td style="border-left:3px solid #C5A572;background:#F7F9FA;padding:8px 1px;">
      <div style="font:bold 10pt 'Segoe UI',sans-serif;color:#000;line-height:1px;mso-line-height-rule:exactly;">{_esc(filename)}</div>
      <div style="font:10pt 'Segoe UI',sans-serif;color:#000;line-height:1px;mso-line-height-rule:exactly;">{len(matches)} match(es)</div>
    </td>
  </tr>
  <tr>
